...
// forge script script/deploy/holesky/Deploy_Symbiotic_Vault.s.sol:ByzantineSymbioticVaultDeployer --rpc-url https://ethereum-holesky-rpc.publicnode.com --chain holesky --broadcast -vvv
contract ByzantineSymbioticVaultDeployer is Script {
    ...
    // Network Limit parameters
    bytes32 public constant NETWORK_ID = "holesky";
    uint256 public constant NETWORK_LIMIT = 1000 ether;
    ...
    function run() public {
        ...
        // 2. Deploy Vault
        address[] memory whitelistedDepositors = new address[](0);
        (address vault, address delegator, address slasher) = IVaultConfigurator(VAULT_CONFIGURATOR).create(
            IVaultConfigurator.InitParams({
                ...
                vaultParams: abi.encode(
                    ...
                    OWNER,              // defaultAdminRoleHolder
                    OWNER,              // depositWhitelistSetRoleHolder
                    OWNER,              // depositorWhitelistRoleHolder
                    OWNER,              // isDepositLimitSetRoleHolder
                    OWNER               // depositLimitSetRoleHolder
                ),
    ...
    function _getSlasherParams() internal view returns (bytes memory) {
        return abi.encode(
            ISlasher.InitParams({
